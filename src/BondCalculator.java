 ...
 * @author Sutherland
 */
public class BondCalculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bond Calculator");

        jLabel3.setText("Interest rate (%)");

        jLabel4.setText("Deposit amount (R)");

        jLabel5.setText("Number of years");

        jButton1.setText("Calculate");

        jLabel2.setText("Details of property");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Address", "Area", "Bedrooms", "Bathrooms", "Price"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BondCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
